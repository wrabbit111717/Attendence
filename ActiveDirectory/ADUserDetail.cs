...
namespace ActiveDirectory
{
    public class ADUserDetail
    {
        ...
        private String _groupPrincipal;
        ...
        public String GroupPrincipal
        {
            get { return _groupPrincipal; }
        }
        ...
        private static String GetProperty(DirectoryEntry userDetail, String propertyName)
        {
            ...
            {
                String property = userDetail.Properties[propertyName][0].ToString();
                return property;
            }
            else
            {
