...
namespace Attendance.Infrastructure.Migrations
{
    ...
    [Migration("20231020121358_AddBriefcaseInspectionSourceCode")]
    partial class AddBriefcaseInspectionSourceCode
    {
            ...
            modelBuilder.Entity("Attendance.Models.Briefcase", b =>
                {
                    ...
                    b.Property<string>("InspectionSourceCode")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("UserId", "InspectionCode")
                        .IsUnique();
